...
public class SwitchInstruction extends AbstractInstruction {
    ...
    public SwitchInstruction(CS2Instruction opcode, List<Integer> cases, List<Label> targets) {
        super(opcode);
        this.cases = cases;
...
//        this.sort();
    ...
    public String toString() {
        ...
        for (int i = 0; i < cases.size(); i++) {
            ...
            bld.append("\t").append(Opcodes.getOpcodeName(CS2Instruction.GOTO)).append("\t").append(targets.get(i).toString()).append(" \r\n");
        }
        bld.append("}");
        return bld.toString();
    }
