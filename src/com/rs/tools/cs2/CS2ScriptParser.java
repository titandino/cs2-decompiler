...
import static com.rs.tools.cs2.ast.LoopNode.LOOPTYPE_WHILE;
...
import com.rs.tools.cs2.ast.IIntConstantNode;
...
//        FunctionNode func = CS2ScriptParser.parse(input, new FunctionDatabase(new File("opcodes_db.ini"), false), new FunctionDatabase(new File("scripts_db.ini"), true));
//        if (func != null) {
...
//    }
    ...
    public static FunctionNode parse(String input, FunctionDatabase opcodesDatabase, FunctionDatabase scriptsDatabase) {
        ...
        try {
            ...
            String msg = parser.currentLine.toString().replace('\t', ' ') + "\r\n";
    ...
    public FunctionNode parseScriptDefinition() {
        ...
        while (curr.equals("define")) {
            ...
            if (REG_INT.test(curr)) {
            	CS2Instruction id = CS2Instruction.getByOpcode(Integer.parseInt(curr));
                advance();
                if (!copied) {
...
//            return new UnaryExpr(prefix, expr);
        ...
        if (curr.equals(LEFT_PAREN)) {
            ...
            if (cast != null) {
                ...
                advance();
                return CS2TypeUtil.cast(parseOperand(), CS2Type.of(castTo));
            }
...
//                assert arg != null : "Argument expected";
    ...
    private ExpressionNode parsePrimitive() {
        ...
        switch (value) {
            ...
            case "CTX_WIDGET":
                advance();
                return new PlaceholderValueNode(value, -2147483645, CS2Type.ICOMPONENT);
            ...
            case "DRAG_WIDGET":
                advance();
                return new PlaceholderValueNode(value, -2147483642, CS2Type.ICOMPONENT);
